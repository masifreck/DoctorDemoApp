...
const DoctorAppintmentHistory = ({navigation}) => {
  const appointments = [
    {
      id: 1,
  ...
  const handleSeeDetails = appointment => {
    ...
    navigation.navigate('DoctorAppointmentHistoryDetails', {appointmentData: appointment});
  };
...
export default DoctorAppintmentHistory;
